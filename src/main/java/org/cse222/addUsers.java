...
public class addUsers {
    public void addDoctors(Database databaseRef){
        ...
        doctors.put(11111,new Doctor("Hayri","Tas",29,'b',new Address(),200,1,1,12,databaseRef));
        doctors.put(11112,new Doctor("Ali","Yilmaz",56,'b',new Address(),201,2,1,12,databaseRef));
        doctors.put(11113,new Doctor("Veli","Yilmaz",55,'b',new Address(),202,3,1,12,databaseRef));
        doctors.put(11114,new Doctor("Handan","Ser",43,'b',new Address(),203,4,1,12,databaseRef));
        doctors.put(11115,new Doctor("Tuba","Bak",42,'b',new Address(),204,5,1,12,databaseRef));
        doctors.put(11116,new Doctor("Yasemin","Serin",44,'b',new Address(),205,6,2,12,databaseRef));
        doctors.put(11117,new Doctor("Asiye","Kartal",46,'b',new Address(),206,7,2,12,databaseRef));
        doctors.put(11118,new Doctor("Esra","Serim",36,'b',new Address(),207,8,2,12,databaseRef));
        doctors.put(11119,new Doctor("Nevra","Merik",38,'b',new Address(),208,9,2,12,databaseRef));
        doctors.put(11120,new Doctor("Esranur","Soysal",35,'b',new Address(),209,10,2,12,databaseRef));
        doctors.put(11121,new Doctor("Fadime","Arıcan",33,'b',new Address(),210,12,3,12,databaseRef));
        doctors.put(11122,new Doctor("Fatih","Ak",32,'b',new Address(),211,11,3,12,databaseRef));
        doctors.put(11123,new Doctor("Murat","Sak",31,'b',new Address(),212,12,3,12,databaseRef));
        doctors.put(11124,new Doctor("Erkan","Sengul",35,'b',new Address(),213,13,4,12,databaseRef));
        doctors.put(11125,new Doctor("Görkem","Ayri",46,'b',new Address(),214,14,5,12,databaseRef));
        doctors.put(11126,new Doctor("Yusuf","Anıl",34,'b',new Address(),215,15,5,12,databaseRef));
        doctors.put(11127,new Doctor("Ahmet","Mert",29,'b',new Address(),216,16,5,12,databaseRef));
        doctors.put(11128,new Doctor("Seda","Mert",29,'b',new Address(),217,17,5,12,databaseRef));
    ...
    public void addConsultant(Database database){
        ...
        consultants.add(new Consultant("Ayse","Alem",25,'g',new Address(),302,1,1,database));
        consultants.add(new Consultant("Halime","Alem",25,'g',new Address(),302,2,2,database));
        consultants.add(new Consultant("Servet","Ser",25,'g',new Address(),303,3,1,database));
        consultants.add(new Consultant("Gul","Male",25,'g',new Address(),304,4,1,database));
