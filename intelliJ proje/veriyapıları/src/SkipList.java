...
public class SkipList<E extends Comparable<E>>
{
    ...
    public E find(E target)
    {
        ...
        if(pred.length != 0 && pred[0].links != null && pred[0].links[0] != null && pred[0].links[0].data.compareTo(target) == 0)
    ...
    public boolean add(E item)
    {
        ...
        if(pred.length != 0 && pred[0].links != null && pred[0].links[0] != null && pred[0].links[0].data.compareTo(item) == 0)
            return false;
    ...
    /**
     * Recompute the max cap with given level
    ...
    static class SLNode<E>
    {
        ...
        @Override
        public String toString() { return (data.toString() + " |" + links.length + "|"); }
    }
}